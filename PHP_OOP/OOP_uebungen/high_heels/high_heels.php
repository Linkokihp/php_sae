...
<input type="text" size="10" name="Sexy" id="Sexy" value=""> <label for="">Wie sexy sind die High-Heels? (Wert von 0 bis 1, Kommazahlen bitte <strong>mit Punkten</strong> schreiben)</label><br><br>
<input type="text" size="10" name="Erfahrung" id="Erfahrung" value=""> <label for="">Erfahrung im Tragen von hohen Schuhen in Jahren</label><br><br>
<input type="text" size="10" name="Preis" id="Preis" value=""> <label for="">Preis der Schuhe in CHF</label><br><br>
<input type="text" size="10" name="Mode" id="Mode" value=""> <label for="">Vor wie vielen Monaten waren die Schuhe in Mode? (bei aktuellen Trends 0 eingeben)</label><br><br>
<input type="text" size="10" name="Alkohol" id="Alkohol" value=""> <label for="">Wie viele Gläser hochprozentigen Alkohols werden vor dem Ausgang getrunken?</label><br><br>
<input type="text" size="10" name="Groesse" id="Groesse" value=""> <label for="">Schuhgrösse (Schweizer Schuh-Nummer)</label><br><br>
...
<strong>Nimm also bitte die Formel nicht allzu Ernst!</strong></p>
<hr>
	<footer>
