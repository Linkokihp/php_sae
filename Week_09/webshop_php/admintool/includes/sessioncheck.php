<?php
session_name(CUSTOM_SESSIONNAME); // key Phil s session statt PHPSESSID - vor session_start() und in einer App immer gleich (da sonst die Session nicht mehr gefunden wird)
